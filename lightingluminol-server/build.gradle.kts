...
paperweight {
    ...
    val fork = forks.register("lightingluminol") {
...
sourceSets {
    main {
        ...
        java { srcDir("../lightingluminol-server/src/main/java") }
        resources { srcDir("../lightingluminol-server/src/main/resources") }
    }
    test {
...
dependencies {
    implementation(project(":lightingluminol-api"))
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Version" to "$mcVersion-${build ?: "DEV"}-local",
            "Implementation-Vendor" to "Local Build",
            "Specification-Title" to "LightingLuminol",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Paper Team",
            "Brand-Id" to "papermc:lightingluminol",
