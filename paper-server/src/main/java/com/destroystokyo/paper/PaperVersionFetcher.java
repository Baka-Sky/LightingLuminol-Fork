...
public class PaperVersionFetcher implements VersionFetcher {
    ...
    private static final String DOWNLOAD_PAGE = "https://github.com/LuminolMC/LightingLuminol"; // LightingLuminol
    private static final String REPOSITORY = "LuminolMC/LightingLuminol"; // LightingLuminol
    ...
    private static Optional<MinecraftVersionFetcher> fetchMinecraftVersionList() {
        ...
        try {
            final URL versionsUrl = URI.create("https://fill.papermc.io/v3/projects/lightingluminol").toURL(); // LightingLuminol
            ...
            try (final BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream(), StandardCharsets.UTF_8))) {
                ...
                for (final String latestVersion : versionList) {
                    ...
                    try {
                        final URL buildsUrl = URI.create("https://fill.papermc.io/v3/projects/lightingluminol/versions/" + latestVersion + "/builds/latest").toURL(); // LightingLuminol
    ...
    private static int fetchDistanceFromSiteApi(final int jenkinsBuild) {
        try {
            final URL buildsUrl = URI.create("https://fill.papermc.io/v3/projects/lightingluminol/versions/" + PaperVersionFetcher.BUILD_INFO.minecraftVersionId() + "/builds").toURL(); // LightingLuminol
