...
public record ServerBuildInfoImpl(
    ...
    private static final Key BRAND_LIGHTINGLUMINOL_ID = Key.key("papermc", "lightingluminol"); // LightingLuminol
    ...
    private ServerBuildInfoImpl(final Manifest manifest) {
        this(
            getManifestAttribute(manifest, ATTRIBUTE_BRAND_ID)
                .map(Key::key)
                .orElse(BRAND_LIGHTINGLUMINOL_ID), // LightingLuminol
            getManifestAttribute(manifest, ATTRIBUTE_BRAND_NAME)
                .orElse("LightingLuminol"), // LightingLuminol
